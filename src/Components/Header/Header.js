...
function Header() {
  ...
  useEffect(() => {
    ...
    const footer = document.getElementById("footer"); // Footer nu id = footer j hovanu
    ...
    checkFooterVisible(); // Initial check
  ...
  return (
    <>
      ...
      <section>
        <div
          className="d-none d-md-block qr_code animZoomIn"
          ref={qrRef}
        >
          <div className="model">
            <LazyImage
